        ...
        const participantsHtml = `
          <div class="participants">
            ...
            <ul class="participants-list">
              ${details.participants.map(p => `\n                <li class="participant-item">${p} <button class="participant-remove" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(p)}" aria-label="Remove ${p}">✕</button></li>`).join('')}
            </ul>
          </div>
        `;
